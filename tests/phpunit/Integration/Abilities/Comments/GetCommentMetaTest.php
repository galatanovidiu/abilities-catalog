<?php
/**
 * Integration tests for the og-comments/get-meta ability.
 *
...
/**
 * Exercises og-comments/get-meta end-to-end: a registered show_in_rest comment-meta
...
final class GetCommentMetaTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$this->assertNotNull( wp_get_ability( 'og-comments/get-meta' ) );
	}
	...
	public function test_get_returns_registered_meta_value(): void {
		...
		$result = wp_get_ability( 'og-comments/get-meta' )->execute( array( 'id' => $this->comment_id ) );
	...
	public function test_get_keys_filter_returns_subset(): void {
		...
		$result = wp_get_ability( 'og-comments/get-meta' )->execute(
			array(
				'id'   => $this->comment_id,
	...
	public function test_get_missing_comment_returns_invalid_id_not_permission(): void {
		...
		$result = wp_get_ability( 'og-comments/get-meta' )->execute( array( 'id' => 999999 ) );
