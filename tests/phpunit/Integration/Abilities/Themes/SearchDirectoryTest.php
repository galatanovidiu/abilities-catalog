<?php
/**
 * Integration tests for the og-themes/search-directory ability.
 *
 ...
 * error-preservation contract for the og-themes/search-directory ability.
 *
...
final class SearchDirectoryTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$this->assertNotNull( wp_get_ability( 'og-themes/search-directory' ) );
	}
	...
	public function test_returns_shaped_items_and_pagination_for_admin(): void {
		...
		$result = wp_get_ability( 'og-themes/search-directory' )->execute( array( 'search' => 'twenty' ) );
	...
	public function test_rating_fields_are_requested(): void {
		...
		wp_get_ability( 'og-themes/search-directory' )->execute( array( 'search' => 'twenty' ) );
	...
	public function test_has_more_is_false_when_page_covers_all_results(): void {
		...
		$result = wp_get_ability( 'og-themes/search-directory' )->execute(
			array(
				'search'   => 'twenty',
				'page'     => 1,
				'per_page' => 10,
	...
	public function test_output_schema_declares_pagination_fields(): void {
		$schema = wp_get_ability( 'og-themes/search-directory' )->get_output_schema();
