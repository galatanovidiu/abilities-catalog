<?php
/**
 * Integration tests for the themes/remove-theme-mod ability.
 *
...
/**
 * Exercises themes/remove-theme-mod registration, remove semantics, and the gate.
 */
final class RemoveThemeModTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$this->assertNotNull( wp_get_ability( 'themes/remove-theme-mod' ) );
	}

	public function test_output_schema_requires_name_and_removed(): void {
		$schema = wp_get_ability( 'themes/remove-theme-mod' )->get_output_schema();
	...
	public function test_removes_existing_mod_and_reads_back_gone(): void {
		...
		$result = wp_get_ability( 'themes/remove-theme-mod' )->execute(
