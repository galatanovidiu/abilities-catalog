<?php
/**
 * Integration tests for the themes/list-theme-mods ability.
 *
...
/**
 * themes/list-theme-mods wraps core `get_theme_mods()` and returns the active
...
final class ListThemeModsTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$ability = wp_get_ability( 'themes/list-theme-mods' );

		$this->assertNotNull( $ability );
		$this->assertSame( 'themes/list-theme-mods', $ability->get_name() );
	}
	...
	public function test_admin_lists_theme_mods_including_a_seeded_one(): void {
		...
		$result = wp_get_ability( 'themes/list-theme-mods' )->execute();
