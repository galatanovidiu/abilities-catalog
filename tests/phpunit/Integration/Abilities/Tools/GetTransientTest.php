<?php
/**
 * Integration tests for the tools/get-transient ability.
 *
...
/**
 * Exercises tools/get-transient registration, read semantics, and the gate.
 */
final class GetTransientTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$this->assertNotNull( wp_get_ability( 'tools/get-transient' ) );
	}

	public function test_output_schema_requires_found_key_network_value(): void {
		$schema = wp_get_ability( 'tools/get-transient' )->get_output_schema();
	...
	public function test_reads_existing_transient_value(): void {
		...
		$result = wp_get_ability( 'tools/get-transient' )->execute(
