...
/**
 * Exercises the adapter-backed single-user read end-to-end: a real user in, a
 * flat shaped record out, with permission enforced by the wrapped REST route on
 ...
 * them in edit context. Route denials surface through execute() as the real REST
 * error (rest_user_cannot_view / rest_forbidden_context), not the generic
