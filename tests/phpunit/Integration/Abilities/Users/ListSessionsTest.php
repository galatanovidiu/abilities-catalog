<?php
/**
 * Integration tests for the users/list-sessions ability.
 *
...
/**
 * Exercises users/list-sessions end-to-end: seeding sessions via
...
final class ListSessionsTest extends TestCase {
	...
	public function test_ability_is_registered(): void {
		$this->assertNotNull( wp_get_ability( 'users/list-sessions' ) );
	}
	...
	public function test_admin_reads_another_users_sessions(): void {
		...
		$result = wp_get_ability( 'users/list-sessions' )->execute( array( 'user_id' => $this->user_id ) );
	...
	public function test_default_reads_current_user(): void {
		...
		$result = wp_get_ability( 'users/list-sessions' )->execute( array() );
	...
	public function test_missing_user_returns_invalid_id_not_permission(): void {
		...
		$result = wp_get_ability( 'users/list-sessions' )->execute( array( 'user_id' => 99999999 ) );
