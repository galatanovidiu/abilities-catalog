...
final class ServerTest extends TestCase {
	...
	/**
	 * Booting registers the REST route, exposes the curated tools plus shared resources
	 * and prompt, publishes owner-enabled abilities to the adapter's default server,
	 * and runs an ability end-to-end.
	 *
	...
	public function test_booting_wires_domain_tools_route(): void {
		...
		foreach ( self::CURATED_DOMAINS as $slug ) {
			$description = $server->get_mcp_tool( $slug )->get_protocol_record( $schema )->getDescription();
