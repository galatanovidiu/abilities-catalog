...
final class AttachPostTerms implements Ability {
	 ...
	 *
	 * Mirrors how the REST post controller gates taxonomy assignment — the
	 * taxonomy's `assign_terms` capability and object-level `edit_post`.
	 *
	 * @param mixed $input The validated input data.
	 * @return bool True if the current user may attach the terms.
	 */
