...
/**
 * Read ability: `templates/list-block-binding-sources`.
 *
 ...
 * `templates/get-block-binding-source`. The private value-resolver callback each
...
final class ListBlockBindingSources implements Ability {
	...
	public function name(): string {
		return 'templates/list-block-binding-sources';
	}
					...
					'sources' => array(
						...
						'items'       => array(
							...
							'properties'           => array(
								'name'         => array(
									'type'        => 'string',
									'description' => __( 'The block-binding source name (e.g. "core/post-meta"). Pass this to templates/get-block-binding-source.', 'abilities-catalog' ),
								),
								'label'        => array(
									'type'        => 'string',
	 ...
	 *
	 * Mirrors `templates/list-block-types`: block-binding sources are editor
