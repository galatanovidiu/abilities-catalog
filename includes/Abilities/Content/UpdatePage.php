...
final class UpdatePage implements Ability {
	 ...
	 *
	 * Requires object-level `edit_post` on the target (mapped to page caps via
	 * `map_meta_cap`); additionally `publish_pages` when the requested status
	 * would publish, and `edit_others_pages` when reassigning the page to
	 * another user.
	 *
	 * @param mixed $input The validated input data.
	 * @return bool True if the current user may update the requested page.
	 */
